def zaglushka():
    return "Синтаксическая ошибка в условии конструкции if. При сравнении переменной с определенными данными следует использовать двойной знак равенства, а не одинарный."
